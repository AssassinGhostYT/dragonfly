...
// pistonFace converts a cube.Face to the specific integer ID used by pistons in Bedrock.
// According to the Wiki (Piston Base): 0:Down, 1:Up, 2:South, 3:North, 4:East, 5:West.
